    ...
    if(type == 'program'):
       ...
       # p[0] = '(' + str(p[2]) + ')' + 'stmt'
        ...
        if (len(p) == 2):
            ...
            p[0] = Node([p[3], p[4]], str(p[1])+'-'+str(p[2]))
        ...
        if(len(p) == 3):
            ...
            p[0] = Node([p[4],p[6]], 'elsif')
            #p[0] = '(' + str(p[4]) + ',' + str(p[6]) + ')elsif'
        elif (len(p) == 8):
            p[0] = Node([p[4],p[6],p[7]], 'elsif')
            #p[0] = '(' + str(p[4]) + ',' + str(p[6]) + ')elsif' + ',' + p[7]

    elif(type == 'doWhile'):
        p[0] = Node([p[2],p[5]], 'doWhile')
        #p[0] = '(' + str(p[2]) + ',' + str(p[5]) + ')doWhile'

    elif(type == 'forLoop'):
        p[0] = Node([p[3],p[5], p[7], p[9]], 'forLoop')
        ...
        if (len(p) == 2):
            ...
            expression = '"' + str(p[1]) + str(p[2]) + '"'
            p[0] = Node(expression)
        elif (len(p) == 3):
            #p[0] = '(' + '"' + str(p[1]) + '"' + ')' + str(p[2])
            p[0] = Node('"' + str(p[1]) + '"', p[2])
        elif (len(p) == 5):
